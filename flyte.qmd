...
[Flyte](https://flyte.org/) is a workflow orchestration platform using Kubernetes and S3 object storage.

![](images/favicon-flyte-docs.webp){.absolute top=0 right=100 width="80"}
...
[PyTorch MNIST training](https://docs.flyte.org/en/latest/flytesnacks/examples/mnist_classifier/pytorch_single_node_and_gpu.html)
